...
* **A cell that never started.** ``nbn/bench/core/cell_runner`` caps each
...
Run::
    ...
    python -m nbn.bench.diagnostics.triage_oom_rows PATH [PATH ...]
    python -m nbn.bench.diagnostics.triage_oom_rows            # scans results
