...
from nbn.bench.domains.base import FailedProblem
...
# Ported from nbn/bench/_crash_test_utils.py::_STRUCTURAL_LIMIT_MARKERS.
# ---------------------------------------------------------------------------
...
class Runner:
    ...
    def _run_cell(
        ...
        *,
        ...
        from nbn.bench.core.cell_runner import run_cell_in_subprocess
