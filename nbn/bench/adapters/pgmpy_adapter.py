...
The old adapter at nbn/bench/baselines/pgmpy_adapter.py is untouched
and continues to serve the v0.12 runner.

Reference: docs/v0.13-benchmark-redesign.md §4.1
Old (functional) adapter: nbn/bench/baselines/pgmpy_adapter.py
"""
...
class PgmpyAdapter:
    ...
    def _fit_lg(self, problem: BenchmarkProblem) -> None:
        ...
        Ported faithfully from nbn/bench/baselines/pgmpy_adapter.py::_fit_lg().
    ...
    def _lg_posterior_moments(
        ...
        nbn/bench/baselines/pgmpy_adapter.py::_lg_posterior_moments().
