"""Generate the six Colab-ready benchmark notebooks under notebooks/.
...
COLAB_BASE = "https://colab.research.google.com/github/Giovannibriglia/NeuralBayesianNetworks/blob/master/notebooks"
...
EXPERIMENTS = [
    dict(
        ...
        sub="inference",
        config="nbn/bench/configs/synthetic/speed/inference_speed.yaml",
        benchmark="synthetic",
    ...
    dict(
        ...
        sub="param-learning",
        config="nbn/bench/configs/synthetic/complete/parameter_learning_complete.yaml",
        benchmark="synthetic",
    ...
    dict(
        ...
        description=(
            ...
            "ship with the repo under `nbn/bench/data/bnlearn/`."
        ),
...
| Results dir | `results/benchmark_{exp['benchmark']}_{exp['config_name']}_<timestamp>/` |
...
Runs `nbn-bench {exp['sub']}` on the config through `python -m nbn.bench.cli` (identical to the console script,
